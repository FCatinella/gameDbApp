...
internal class TheGameDbServiceImpl(
    ...
    override suspend fun getPopular(
        ...
        limit: Int,
        updateDateTime: Long
    ): List<PopularityPrimitiveDataModel> {
        val result = httpClient.post {
            method = HttpMethod.Post
            this.url {
                protocol = URLProtocol.HTTPS
            ...
            //setBody("fields *; sort value $sort; limit $limit; where popularity_type = $popularityType & created_at > $updateDateTime;")
            setBody("fields *,game; sort value $sort; limit $limit; where popularity_type = $popularityType & created_at > $updateDateTime;")
